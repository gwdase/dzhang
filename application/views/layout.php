...
<html>
	<head>
		...
		<style type="text/css">
			...
			@import url(<?php echo site_url('media/js/smoothness/jquery-ui.css'); ?>);
		</style>
		<script type="text/javascript" src="<?php echo site_url('media/js/jquery-core-min.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo site_url('media/js/jquery-ui-min.js'); ?>"></script>
		<script>
		$(function(){
			$('#tabs').tabs();
			});
